...
def generate_review_findings(
    ...
    if existing is not None and force:
        ...
        target = KinematicReviewFindingSet(
            ...
            schema_version=REVIEW_FINDINGS_SCHEMA,
            rule_set=rule_set,
            rule_version=rule_version,
            engine_version=_ENGINE_VERSION,
            threshold_basis=threshold_basis,
            source_annotation_revision=record.source_revision,
            source_metric_schema_version=record.schema_version,
            source_metric_calculator=record.calculator,
            source_metric_calculator_version=record.calculator_version,
            source_metric_hash=metric_hash,
